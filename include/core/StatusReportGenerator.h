...
namespace dtn
{
	namespace core
	{
		...
		private:
			 ...
			 */
			dtn::data::Bundle createStatusReport(const dtn::data::Bundle &b, dtn::data::StatusReportBlock::TYPE type, dtn::data::StatusReportBlock::REASON_CODE reason = dtn::data::StatusReportBlock::NO_ADDITIONAL_INFORMATION);
		};
	}
}
